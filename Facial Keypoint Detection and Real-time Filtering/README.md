...
This project requires GPU acceleration to run efficiently. Please refer some instructions for setting up a GPU instance for this project. )


### Local Environment Instructions

You should follow the AWS instructions for best results.
...
All of the data you'll need to train a neural network is in the CV-FacialKeypoints repo, in the subdirectory `data`. In this folder are a zipped training and test set of data.
...
__NOTE:__ While some code has already been implemented to get you started, you will need to implement additional functionality to successfully answer all of the questions included in the notebook. __Unless requested, do not modify code that has already been included.## Project Rubric
